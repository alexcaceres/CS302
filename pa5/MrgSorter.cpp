 ...
 * @note Derived methods use specific strategy to sort objects
 * @note Sets sort success flag to true at start;
 *       my merge sort checks if the left is less than the right 
 *       then calls the merge sort function and the merge function
 *       
 */
 ...
 *       and resetting vector data at locations, uses a DateType array with getSize()
 */
