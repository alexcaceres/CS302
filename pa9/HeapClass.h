...
class HeapClass
   {
    ...
    private:
       ...
       bool addItemHelper(const KeyType &newKey, const DataType &newData, HeapNode<KeyType, DataType> *&parentPtr, HeapNode<KeyType,  DataType> *&workingPtr, int row);
       
       // added functions for assignment 
       void trickleUp(HeapNode<KeyType, DataType> *workingPtr);
       
       bool removeItemHelper(HeapNode<KeyType, DataType> *&workingPtr, int row);
       
       void trickleDown(HeapNode<KeyType, DataType> *workingPtr);
       
       int compareTo(HeapNode<KeyType, DataType> *leftPtr, HeapNode<KeyType, DataType> *rightPtr);
